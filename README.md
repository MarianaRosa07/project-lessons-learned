...
- Data para entrega final do projeto: `18/09/2023 23:59`.
...
- Use o comando: `git clone git@github.com:tryber/sd-037-project-lessons-learned.git`
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-037-project-lessons-learned`
...
- Verifique que você está na raiz do projeto:
  - Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/maria/code/**sd-037-project-lessons-learned**_
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-037-project-lessons-learned/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-037-project-lessons-learned/pulls) e confira que o seu _Pull Request_ está criado
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH37&template=betrybe/sd-0x-project-lessons-learned)
